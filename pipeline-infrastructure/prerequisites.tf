...
resource "aws_ssm_parameter" "instance_type" {
  name  = "/demo/ec2/instance-type-justromeon"
  type  = "String"
  value = "t2.micro"
...
resource "aws_ssm_parameter" "allowed_cidr" {
  name  = "/demo/security/allowed-cidr-justromeon"
  type  = "String"
...
resource "aws_ssm_parameter" "amazon_linux_ami" {
  name  = "/demo/ec2/ami-id-justromeon"
  type  = "String"
...
resource "aws_secretsmanager_secret" "api_key" {
  name        = "demo/app/api-key-justromeon"
...
resource "aws_ssm_parameter" "test_instance_type" {
  name  = "/demo/test/ec2/instance-type-justromeon"
  type  = "String"
  value = "t2.micro"
...
resource "aws_ssm_parameter" "prod_instance_type" {
  name  = "/demo/prod/ec2/instance-type-justromeon"
  type  = "String"
  value = "t2.small"
...
resource "aws_secretsmanager_secret" "test_api_key" {
  name        = "demo/test/api-key-justromeon"
...
resource "aws_secretsmanager_secret" "prod_api_key" {
  name        = "demo/prod/api-key-justromeon"
